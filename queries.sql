...
join games g on g.id = h.gameId  where g.startTime like '2019-06-06%' 
 order by h.homeRuns desc, g.startTime desc ;
...
join games g on g.id = ps.gameId 
 where ps.inningsPitched >= 4 and  g.startTime like '2019-06-06%' 
